    ...
    public sealed class MainWindow : Window
    {
        ...
        public override void Draw()
        {
            ...
            if (ImGui.CollapsingHeader("How to use"))
            {
                ...
                ImGui.BulletText("Click 'Scan Missions' to read current mission items and quantities.");
                ImGui.BulletText("Click 'Calculate Materials' to expand items into required components.");
                ImGui.BulletText("Use the options below to customize output.");
            }
